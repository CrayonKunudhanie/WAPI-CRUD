<div>
                ...
                @foreach ($dataKontak as $key => $value)
                    <tr class="bg-gray-100">
                        ...
                        <td class="border-b p-2 text-center">
                            ...
                            <!-- Delete Button -->
                            <button class="text-red-600 hover:text-red-800" wire:click="delete_confirmation({{ $value->id }})">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto" x-data="{ open: @entangle('isModalOpen') }" x-show="open" @keydown.escape.window="open = false">
        <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0">
            ...
            >
                ...
                <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="delete" type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 sm:ml-3 sm:w-auto sm:text-sm">
                        Ya, Delete
                    </button>
                    <button @click="open = false" type="button" class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-white bg-gray-600 border border-transparent rounded-md shadow-sm hover:bg-gray-700 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        gajadi
                    </button>
                </div>
            </div>
