    ...
    <div class="flex">
        <aside class="w-64 bg-green-900 text-white p-4">
            ...
            <nav class="flex flex-col space-y-4">
                <a href="{{route('index')}}" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
        ...
        <aside class="w-64 bg-green-900 text-white p-4">
            ...
            <nav class="flex flex-col space-y-4">
                <a href="index.html" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                 ...
                 <a href="bc. " class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
